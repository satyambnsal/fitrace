      ...
      <IonContent>
        ...
        >
          ...
          <ul className="flex flex-col gap-4 list-v1">
            ...
            <li className="border border-muted-500 rounded-md p-4 left-arrow flex items-start gap-2">
              <img src={arrow} alt="" />
              The numbers must be placed in ascending order from left to right across the available
              slots.
            </li>
            ...
            <li className="border border-muted-500 rounded-md p-4 left-arrow flex items-start gap-2">
              <img src={arrow} alt="" />
              If you make a mistake, you can undo your last move by clicking or tapping the "Undo"
              button.
            </li>
            <li className="border border-muted-500 rounded-md p-4 left-arrow flex items-start gap-2">
              <img src={arrow} alt="" />
            ...
            <li className="border border-muted-500 rounded-md p-4 left-arrow flex items-start gap-2">
              <img src={arrow} alt="" />
              The fewer moves you have remaining at the end of the game, the higher your ranking
          ...
          <div className="mt-4 border rounded-md p-4">
            <strong>Note: </strong>
            The score is displayed as "Remaining Moves." A lower number of remaining moves indicates
            a better score and a higher ranking on the leaderboard. By following these rules, you'll
            be able to navigate the game and aim for the highest possible ranking on the
